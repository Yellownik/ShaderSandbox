        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                float agePercent = v.uv.z;
                float3 attractPoint = UnityObjectToClipPos(float3(0, 0, 0));
                o.vertex.xyz = lerp(o.vertex.xyz, attractPoint, agePercent * agePercent * agePercent);
